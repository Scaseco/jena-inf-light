...
//    public static Function<Graph, Graph> asGraphTransform(Function<Match<Node, Triple>, Match<Node, Triple>> tupleFinderTransform) {
//        return graph -> {
//            Match<Node, Triple> in = new MatchGraph(graph);
//            Match<Node, Triple> out = tupleFinderTransform.apply(in);
//            Graph r = GraphMatch.adapt(graph, out);
//            return r;
//        };
//    }
